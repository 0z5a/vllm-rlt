...
Lead with findings in priority order, followed by a brief validation/scope note
and the reviewed SHA. If there are none, say so without implying unrun accuracy,
