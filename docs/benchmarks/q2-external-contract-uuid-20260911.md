# Q2 cached external comparison — corrected preflight attempt

**No model-generation or performance result is claimed.** This is the external FP32 deliverable of Q2 #8; task quality, BF16 and adaptive behavior remain outside this finite experiment. The design is [q2-external-design.md](q2-external-design.md).
...
| Input | Identity |
| --- | --- |
| Execution source | `3c99076eb305c5569a703cb169fc732f1c1a2696`; `/data/hsliu2/tmp/vllm-lt-q2-external-exec-v3`; 136 tracked files |
| Canonical plan | `a80afaaaa707021eb84a79be02f54dc078574a5915a21243ae4ad5678eda84e8` |
| Exact plan file | `0de3120382e23fc0956265e539b108a02117c2e12b268daad27d6237a566a44a`; 179,123 bytes; `/data/hsliu2/tmp/vllm-lt-q2-external/artifacts/q2-plan-uuid-20260911/plan.json` |
| Controls | `40d09e0a9bf464667e938538f3c467c31f6b5e57bf5a48ecf51a0c95a12e9dd6` |
...
No CPU result count is inferred by this generator. Preserve root full-suite logs, failed/final fixture logs, exact guards and independent reviews separately. CPU evidence file `/data/hsliu2/tmp/vllm-lt-q2-external/artifacts/q2-cpu-verification-uuid.json`, SHA256 `46e1168a832321c3335b1cee22830f9b141db0a06188dc7008113239f84b1cda`: `{"completed_model_cases_so_far": 0, "full_cpu": {"corresponding_commit": "1af8716cb238121e0a20a84088eaefdcb7a9215c", "format_only_ast_equal": true, "log_sha256": "bae30d478f8bb9bd957a0d48c0729ead5b0d6a0af0514dd00ad812db1033cc3d", "passed": 761, "seconds": 145.99, "skipped": 16, "source_files_unchanged_during_run": 135}, "historical_pre_first_attempt_gpu_runs": 0, "pre_device_report_fix": {"changed_files": ["vllm_lt/benchmarks/q2_external_report.py", "tests/test_q2_external_report.py"], "execution_commit": "c96112fa69f3a3920e86317d80f396400c3d5e10", "focused_passed": 46, "log_sha256": "4e627f5d02c4c9da0b125924b8216f82c444926b9c7c5ec7a3bc59e88c859726", "production_or_driver_changes": false}, "real_cpu_integration": "128 prompt +64 actual native/official greedy outputs match,96 slots,length191; GPU bookkeeping stubbed, no GPU qualification", "reserved_attempts_so_far": 1, "uuid_fix": {"changes": "normalize exact GPU UUID prefix in worker and report; no production/driver/adapter changes", "execution_commit": "3c99076eb305c5569a703cb169fc732f1c1a2696", "focused_passed": 83, "format_only_after_tests": "multiline decorator wrapping in one test; no AST behavior change", "log_sha256": "27314e87a8c7fb9c61ceb09b92e4cbaf63fcec05742f3ee80b64c4c9f3b11bf8", "seconds": 10.36}}`.
...
The CPU probe and source freeze precede this document. Review and DCO-commit the resolved document before this corrected attempt. Do not rerun the probe into its existing output. Commands below are derived reproducible syntax; any exact earlier probe command is retained separately in the commands JSON. This generator executes none of them.

```bash
cd /data/hsliu2/tmp/vllm-lt-q2-external-exec-v3
numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 env OMP_NUM_THREADS=1 PYTHONPATH=/data/hsliu2/tmp/vllm-lt-q2-external-exec-v3 /home/hsliu2/tmp/venvs/vllm-lt-q1/bin/python /data/hsliu2/tmp/vllm-lt-q2-external/artifacts/q2_cpu_cli.py probe --contract /data/hsliu2/tmp/vllm-lt-q2-external-exec-v3/benchmarks/fixtures/ouro-q2-external-contract.json --model /data/hsliu2/tmp/vllm-lt-models/ouro-1.4b --gpu-ids 2 --gpu-uuid GPU-cbf66259-f4ab-0ede-1811-82037dde5924 --output /data/hsliu2/tmp/vllm-lt-q2-external/artifacts/q2-plan-uuid-20260911
gpu run --gpu-ids 2 --wait 30m --timeout 70m --note 'Q2 cached external 3c99076eb305c5569a703cb169fc732f1c1a2696' -- numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 env OMP_NUM_THREADS=1 PYTHONPATH=/data/hsliu2/tmp/vllm-lt-q2-external-exec-v3 /home/hsliu2/tmp/venvs/vllm-lt-q1/bin/python -m vllm_lt.benchmarks.q2_external run --plan /data/hsliu2/tmp/vllm-lt-q2-external/artifacts/q2-plan-uuid-20260911/plan.json --output /tmp/hsliu2-vllm-lt-q2-external-uuid-20260911/run
numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 env OMP_NUM_THREADS=1 PYTHONPATH=/data/hsliu2/tmp/vllm-lt-q2-external-exec-v3 /home/hsliu2/tmp/venvs/vllm-lt-q1/bin/python /data/hsliu2/tmp/vllm-lt-q2-external/artifacts/q2_cpu_cli.py report --run-dir /tmp/hsliu2-vllm-lt-q2-external-uuid-20260911/run
```
...
## Earlier stopped preflight and new bounded attempt

The first reserved attempt used source `c96112fa69f3a3920e86317d80f396400c3d5e10` and GPU2 plan `7c7c58c6043534d479acd8e605b870fa35856a2f088b14160fff74cff170bf71`. It stopped after11.761314598 seconds before model loading, request admission or any of the eight cases. NVIDIA reported `GPU-cbf66259-f4ab-0ede-1811-82037dde5924`; PyTorch reported the same UUID without `GPU-`. The exact-string check rejected that format difference. The initial source's offline report remains **invalid/inconclusive**, with both preflight/controller failures recorded and zero comparable cases. Its raw directory and report were not changed.

Worker teardown recorded zero allocated/reserved bytes. The scheduler released the reservation, and the subsequent metadata showed GPU2 reassigned to another account; it did not show an idle/free device. Unrelated user/process details stay local. The stopped record is `artifacts/q2-stopped-preflight-record.json`; the original raw source remains `/tmp/hsliu2-vllm-lt-q2-external-20260911/run`.

This is one explicitly newly planned attempt after a harness-only correction. The worker and reporter now accept the two exact UUID spellings and continue rejecting malformed/different UUIDs. Native production, official adapter, generation/timing driver, model, GPU2, CPU/NUMA controls, eight-row order, workload and numerical requirements are unchanged. The stopped attempt consumed zero model loads/cases; this new attempt permits at most one load and the original two feasibility, two warmup and four measured cases. Preserve both attempts and do not pool them or relabel the first as passing.

Allow at most30 minutes of scheduler queue time before this attempt, reported separately from its unchanged3600-second experiment and600-second complete-case caps. The70-minute scheduler timeout is outer termination allowance only. Refresh all four scheduler status forms immediately before queueing; earlier AVAILABLE metadata is historical. This is the only corrected attempt declared in this round: stop on the first required failure, with no automatic third attempt, replacement case, extra profiler or measurement. Its raw destination is new and disjoint.

CPU validation:83 focused tests passed10.36 seconds for strict UUID identity, driver and offline-report cases; Ruff/format pass. After those tests only a decorator's multiline wrapping changed. The prior full761-pass suite and46-pass report correction remain historical evidence, not a claimed new full-suite run. The CPU evidence record explicitly separates its historical pre-first-attempt device count from the one already settled reserved attempt.
