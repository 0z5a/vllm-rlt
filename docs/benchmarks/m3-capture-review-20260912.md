...
Raw evidence: `/tmp/hsliu2-vllm-lt-graph-review-ab-v3-20260912/results`. Plan, commands, environment, all results and this audit script are retained beside this report.

[Plans, source hashes, lifecycle results and audited metrics](m3-capture-review-evidence-20260912/report.json) are retained in the adjacent evidence directory. The separate profile plan is `d0a29e10761962d31d491d543b1bff51a39d5d598e8024973635ff6bd66cc799`. Full raw traces and stopped attempts are retained in the local evidence archive described in that directory.
